...
public class Pessoa {
    ...
    //primeiro verificar se ele é nulo, se ele for nulo ele vai dar erro, e nem pode estar vazio
    public void setDocumento (String documento) {
        if (documento == null || documento.isEmpty()) {
            throw new RuntimeException("Documento nao pode ser nulo ou vazio");
        }
    //verificador de pessoa fisica ou juridica, se nenhum dos dois, volta erro de documento invalido
